...
BITCOIND_RPCPORT = "http://127.0.0.1:18443"
...
BITCOIND_BIN = "regtest/programs/bitcoin/bin/bitcoind"
BITCOIN_CLI_BIN = "regtest/programs/bitcoin/bin/bitcoin-cli"
LIGHTNINGD_BIN = "regtest/programs/cln/bin/lightningd"
LIGHTNING_CLI_BIN = "regtest/programs/cln/bin/lightning-cli"
HOLDINVOICE_PLUGIN_BIN = "regtest/programs/cln/holdinvoice"
LND_BIN = "regtest/programs/lnd/lnd"
LNCLI_BIN = "regtest/programs/lnd/lncli"
...
# by moving regtest/services/postgres somewhere and the moving it back when
